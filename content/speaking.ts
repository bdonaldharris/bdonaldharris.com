...
export const signatureTalks = [
  "Consumers to Builders: Preparing Black Entrepreneurs for the AI-Powered Economy",
  "AI and the Future of Black Engineers",
  "Agentic Development Requires Builder Leadership",
